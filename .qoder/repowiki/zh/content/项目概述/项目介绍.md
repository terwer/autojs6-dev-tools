...
## 更新摘要
**变更内容**
- 删除了对 yxs-day-task 项目的提及，强调当前项目的独立性和完整性
- 更新了项目定位描述，突出 Windows 原生高性能版本的独特价值
- 强化了项目作为独立工具集的完整性和自主性
...
## 引言
AutoJS6 可视化开发工具旨在彻底改变 AutoJS6 脚本开发体验。这是一个完全独立且完整的 Windows 原生开发工具，将"截图分析、控件树解析、图像匹配预览、AutoJS6 代码生成"整合到一个高性能的工作台中，帮助开发者告别"截图 → 手动裁剪 → 写代码 → 真机试错"的低效循环，实现"所见即所得"的高效开发。

- **独立性强调**：作为 Windows 原生高性能版本，专注于为 Windows 用户提供最佳的开发体验
...
## 项目结构
项目采用 Clean Architecture 分层，严格解耦 UI、核心业务与基础设施，形成完全独立的开发工具体系：
...
**章节来源**
- [README.md:249-279](file://README.md#L249-L279)
- [README_zh_CN.md:249-279](file://README_zh_CN.md#L249-L279)
...
**章节来源**
- [README.md:185-247](file://README.md#L185-L247)
- [README_zh_CN.md:185-247](file://README_zh_CN.md#L185-L247)
...
**章节来源**
- [README.md:283-306](file://README.md#L283-L306)
- [README_zh_CN.md:283-306](file://README_zh_CN.md#L283-L306)
...
**章节来源**
- [README.md:187-194](file://README.md#L187-L194)
- [README_zh_CN.md:187-194](file://README_zh_CN.md#L187-L194)
- [OpenCVMatchServiceImpl.cs:11-60](file://Infrastructure/Imaging/OpenCVMatchServiceImpl.cs#L11-L60)
...
- [README_zh_CN.md:195-202](file://README_zh_CN.md#L195-L202)
- [PropertyPanelView.xaml.cs:12-31](file://App/Views/PropertyPanelView.xaml.cs#L12-L31)
...
**章节来源**
- [README.md:203-209](file://README.md#L203-L209)
- [README_zh_CN.md:203-209](file://README_zh_CN.md#L203-L209)
- [CanvasView.xaml.cs:24-116](file://App/Views/CanvasView.xaml.cs#L24-L116)
...
**章节来源**
- [README.md:210-239](file://README.md#L210-L239)
- [README_zh_CN.md:210-239](file://README_zh_CN.md#L210-L239)
- [AutoJS6CodeGenerator.cs:11-189](file://Core/Services/AutoJS6CodeGenerator.cs#L11-L189)
...
## 结论
AutoJS6 可视化开发工具通过"双工作区 + 实时预览 + 一键代码生成"的组合拳，系统性地解决了传统开发方式中的反复调试、坐标猜测、跨设备适配与 UI 树查找等痛点。作为完全独立的 Windows 原生开发工具，其 Clean Architecture 分层设计、Win2D 高性能渲染、以及严格的异步与解耦策略，既保证了开发体验，也为长期演进提供了坚实基础。对于 AutoJS6 脚本开发者而言，这不仅是一个工具，更是提升效率与稳定性的关键抓手。该项目的独立性和完整性确保了用户可以获得专注、稳定且高性能的开发体验，无需依赖其他项目或工具集。