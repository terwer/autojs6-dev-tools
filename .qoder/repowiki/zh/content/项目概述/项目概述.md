...
**更新** 项目现已完全自包含，删除了对外部 yxs-day-task 项目的依赖引用，强化了当前项目的独立文档体系。
...
**章节来源**
- [App\Views\MainPage.xaml.cs:156-187](file://App\Views\MainPage.xaml.cs#L156-L187)
...
**更新** 项目现已完全自包含，删除了对外部 yxs-day-task 项目的依赖引用，强化了当前项目的独立文档体系，确保所有开发、测试和部署流程均可在当前项目内完成。
...
- [README_zh_CN.md:114-182](file://README_zh_CN.md#L114-L182)

### 项目文档体系
- 核心文档
  - AGENTS.md：核心设计原则和约束（必读）
  - openspec/project.md：开发清单与验证规则
  - README.md / README_zh_CN.md：项目说明与使用指南
- 技术文档
  - DEVELOPMENT.md / DEVELOPMENT_zh_CN.md：开发与发布指南
  - RELEASE_TEST.md / RELEASE_TEST_zh_CN.md：发布测试文档
  - PROXY.md / PROXY_zh_CN.md：网络代理配置说明

**章节来源**
- [AGENTS.md:1-311](file://AGENTS.md#L1-L311)
- [openspec/project.md:1-374](file://openspec/project.md#L1-L374)