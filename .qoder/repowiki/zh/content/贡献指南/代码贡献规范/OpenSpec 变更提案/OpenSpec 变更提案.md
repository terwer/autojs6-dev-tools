...
## 更新摘要
**所做更改**
- 删除对外部项目工作流的参考，强调当前项目的工作流和实现
- 更新架构总览，突出本项目内部的 OpenSpec 实施流程
- 修改提案编写流程，强调基于当前项目经验的实施指导
- 更新技术要求，聚焦当前项目的技术栈和约束条件
- 强化 AI 助手技能与当前项目工作流的集成
...
**更新** 强调当前项目的工作流和实现，删除对外部项目工作流的参考，确保所有变更都基于本项目的实际经验和约束条件。
...
**更新** 强调这些技能与当前项目工作流的集成，确保所有生成和实施都基于本项目的实际约束和经验。
...
## 架构总览
OpenSpec 在本项目中的应用体现为"提案-设计-规格-任务"的闭环，配合 AI 助手技能实现从需求到实现的自动化与规范化。该架构完全基于当前项目的工作流和实现经验。
...
**更新** 架构总览现在完全反映当前项目的工作流，删除对外部项目的引用，强调本项目的内部实施流程。
...
**更新** 提案现在强调基于当前项目经验的实施指导，删除对外部项目工作流的参考。
...
**更新** 设计现在完全基于当前项目的技术栈和约束条件，强调本项目的架构原则和实现经验。
...
**更新** 规格现在强调与当前项目实现的一致性，确保生成的代码和功能与现有工作流保持兼容。
...
**更新** 任务现在完全基于当前项目的技术栈和实现经验，确保所有任务都符合本项目的约束和最佳实践。
...
**更新** AI 助手技能现在完全集成到当前项目的工作流中，确保所有生成和实施都基于本项目的实际约束和经验。
...
**更新** 依赖分析现在完全基于当前项目的内部结构，删除对外部项目的依赖关系。
...
**更新** 性能考虑现在完全基于当前项目的技术实现，强调本项目的性能优化策略和约束条件。
...
**更新** 故障排除指南现在完全基于当前项目的经验和实现，确保所有解决方案都符合本项目的约束和最佳实践。
...
**更新** OpenSpec 现在完全基于当前项目的工作流和实现经验，确保所有变更都符合本项目的约束、技术栈和最佳实践，删除对外部项目工作流的依赖。

## 附录

### 提案编写流程
- 准备阶段：收集背景信息、受益项目与前置分析报告
- 编写阶段：按照 Proposal 结构撰写 Why/What/Capabilities/Impact
- 评审阶段：依据设计与规格进行技术评审与范围确认
- 批准阶段：根据评审意见修订并获得批准

**更新** 提案编写流程现在完全基于当前项目的工作流，强调基于本项目经验的实施指导。
...
**更新** 技术要求现在完全基于当前项目的技术栈和约束条件，确保所有要求都符合本项目的实现能力和经验。
...
**更新** 提案模板与示例现在完全基于当前项目的实际案例，确保所有模板和示例都符合本项目的实现经验和约束条件。
...
**更新** 提案管理最佳实践现在完全基于当前项目的工作流和验证体系，确保所有管理实践都符合本项目的实际需求和约束。
