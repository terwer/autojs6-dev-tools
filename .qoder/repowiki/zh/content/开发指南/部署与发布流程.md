...
- 增强了 source_ref 参数的描述，提供了更清晰的使用指导和三种场景说明
- 新增了 source_ref 参数的三种使用场景：dev（开发验证）、main（发布候选验证）、生产标签（修复现有发布）
- 更新了相关的工作流配置和使用指南，提升了开发者体验
...
**更新** 本版本反映了 manual-release-test 工作流中 source_ref 参数的重大改进：默认值从 'main' 更改为 'dev'，并提供了更清晰的使用指导和三种场景说明，显著提升了开发者体验。
...
**更新** source_ref 参数的默认值已从 'main' 更改为 'dev'，这使得新功能开发的验证更加便捷，默认直接指向开发分支。
...
**更新** 本版本的 source_ref 参数重大改进进一步明确了 manual-release-test 工作流的使用场景，将默认值从 'main' 更改为 'dev'，为不同阶段的发布需求提供了更清晰的指导，显著提升了开发者体验和工作效率。
