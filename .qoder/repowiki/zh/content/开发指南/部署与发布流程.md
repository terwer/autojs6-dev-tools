...
## 更新摘要
**所做更改**
- 新增应用图标定制功能的集成说明，包括 AppIcon.ico 图标的配置和窗口图标设置
- 新增关于作者按钮的功能说明，包括 HyperlinkButton 的实现和点击事件处理
- 更新了项目结构图，反映新增的图标资源和界面元素
- 增强了发布流程的用户体验功能说明
...
**更新** 本版本新增了应用图标定制和关于作者按钮等用户体验功能的集成，这些新功能提升了应用的专业性和用户友好度，为开发者提供了更好的使用体验。
...
- [scripts/release/Build-MsixPackage.ps1:1-202](file://scripts/release/Build-MsixPackage.ps1#L1-L202)
- [packaging/windows/autojs6-dev-tools.iss:1-75](file://packaging/windows/autojs6-dev-tools.iss#L1-L75)
...
Dev->>CI : 手动触发 manual-release-testsource_ref 默认 dev
...
**更新** release-please 配置现已包含目标分支指定、改进的变更日志分类和 PR 头部信息，这些增强特性提升了发布流程的规范性和可追溯性。
...
**更新** source_ref 参数的默认值已从 'main' 更改为 'dev'，这使得新功能开发的验证更加便捷，默认直接指向开发分支。同时增强了参数描述，提供了更清晰的使用指导。
...
**图表来源**
- [scripts/release/Build-MsixPackage.ps1:46-202](file://scripts/release/Build-MsixPackage.ps1#L46-L202)
...
ResourcePack --> AllFormats["支持 ZIP/EXE/MSIX"]
```
...
**更新** 本版本的 release-please 配置增强和 manual-release-test 工作流的重大改进进一步明确了发布流程的规范性和可维护性，特别是 source_ref 参数默认值的调整和增强的配置选项，为不同阶段的发布需求提供了更清晰的指导，显著提升了开发者体验和工作效率。新增的应用图标定制和关于作者按钮功能进一步提升了产品的专业性和用户体验。
