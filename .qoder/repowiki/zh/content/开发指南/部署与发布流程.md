...
## 更新摘要
**所做更改**
- 更新了 GitHub Actions 工作流安全配置，将 secret 引用从 secrets.GITHUB_TOKEN 更新为 secrets.GH_TOKEN
- 增强了构建系统对 AnyCPU 平台的支持，完善了多平台配置
- 更新了相关的工作流配置和脚本说明
...
**更新** 本版本反映了 GitHub Actions 工作流安全改进和构建系统增强的重要变更。
...
**更新** 本版本的安全改进和构建系统增强进一步提升了发布流程的可靠性与安全性。
