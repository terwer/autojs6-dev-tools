...
**图表来源**
- [App.csproj:71-72](file://App/App.csproj#L71-L72)
...
**章节来源**
- [App.csproj:2-33](file://App/App.csproj#L2-L33)
...
- [App.csproj:83-86](file://App/App.csproj#L83-L86)
- [launchSettings.json:1-14](file://App/Properties/launchSettings.json#L1-L14)
...
**章节来源**
- [App.csproj:27-33](file://App/App.csproj#L27-L33)
...
**更新说明**：根据项目变更要求，已删除 YXS_DAY_TASK_ROOT 环境变量配置，当前项目仅保留必要的 AutoJS6 参考路径配置。
